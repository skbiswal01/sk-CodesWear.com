...
export default function Home() {
  return (
    <div >
      <Head>
        <title>sk-codeswear - wear the code</title>
        <meta name="description" content="sk-codeswear wear the awesome" />
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2  text-gray-900">Wear the code with Sk codeswear</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">wear what you want? what do you want? you want code ? why not wear code</p>
    </div>
