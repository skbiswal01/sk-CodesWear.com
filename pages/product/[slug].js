          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  ...
                  {Object.keys(variants).includes("White") &&
                    Object.keys(variants["White"]).includes(size) && (
                      <button
                        ...
                        className={`border-2 bg-white rounded-full w-6 h-6 focus:outline-nonsize === "White" ? 'border-black' :' border-gray-500'}`}
                      ></button>
                    )}
                  ...
                  {Object.keys(variants).includes("yellow") &&
                    Object.keys(variants["grey"]).includes(size) && (
                      <button
                        ...
                        className={`border-2 bg-gray-500 rounded-full w-6 h-6 focus:outline-none ${
                          color === "grey"
                            ? "border-black"
                            : " border-yellow-500"
                        }`}
              ...
              <div className="flex">
                ...
                <button
                  onClick={() =>
                    buyNow(slug, 1, products.price, products.title, size, color)
                  }
